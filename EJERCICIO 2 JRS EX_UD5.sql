...
CREATE TABLE IF NOT EXISTS proveedores(
    ...
    ciudad CHAR DEFAULT("Ubrique"),
    cod_postal CHAR DEFAULT(11600),
    pais CHAR DEFAULT("España"),
    telefono CHAR(12),
    web BOOLEAN,
...
CREATE TABLE IF NOT EXISTS productos(
    ...
    codigo_producto CHAR CHECK("ES%________"),
    ean13 CHAR UNIQUE NOT NULL CHECK("84%________"),
...
CREATE TABLE IF NOT EXISTS pedidos(
    ...
    estado_pedido ENUM('recibido', 'producción', 'enviado', 'entregado'),
    importe INT UNSIGNED DEFAULT(MIN(0)),
...
CREATE TABLE IF NOT EXISTS detalles_pedidos(
    ...
    precio DECIMAL(10,2),
    cantidad INT UNSIGNED DEFAULT(MIN(0)),
    descuento DECIMAL (1,3),
    iva DECIMAL DEFAULT("0,210"),
