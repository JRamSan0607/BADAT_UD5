...
CREATE TABLE IF NOT EXISTS Participantes(
    ...
    cabeza_serie INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS Partidos(
    ...
    set_1 TINYINT(1) NOT NULL,
    set_2 TINYINT(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS Sets(
    ...
    juegos_1 INT UNSIGNED NOT NULL,
    juegos_2 INT UNSIGNED NOT NULL
);
...
CREATE TABLE IF NOT EXISTS Juegos(
    ...
    puntos_1 INT UNSIGNED NOT NULL,
    puntos_2 INT UNSIGNED NOT NULL,
    tie_break BOOLEAN,
